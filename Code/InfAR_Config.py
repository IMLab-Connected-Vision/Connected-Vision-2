ann_file_test = 'data/InfAR/val.txt'
ann_file_train = 'data/InfAR/train.txt'
ann_file_val = 'data/InfAR/val.txt'
data_root = 'data/InfAR/train/'
data_root_val = 'data/InfAR/val/'
...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='data/InfAR/val.txt',
        data_prefix=dict(video='data/InfAR/val/'),
        pipeline=[
...
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='data/InfAR/train.txt',
        data_prefix=dict(video='data/InfAR/train/'),
        pipeline=[
            dict(io_backend='disk', type='DecordInit'),
            dict(
                clip_len=32,
...
work_dir = './work_dirs/slowfast_r50_InfAR'
